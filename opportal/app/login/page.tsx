...
// 2. Component chính đóng vai trò Wrapper bọc Suspense
export default function LoginPage() {
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4">
            ...
            {/* Phần quan trọng: Bọc form trong Suspense để tránh lỗi build */}
            <Suspense fallback={
                <div className="text-white bg-slate-800/50 p-4 rounded-xl backdrop-blur">
